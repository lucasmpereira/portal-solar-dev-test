...
# Calc the PowerGerator's cubage
PowerGenerator.all.each do |pwr_gntr| 
  pwr_gntr.cubage = (pwr_gntr.lenght * pwr_gntr.width * pwr_gntr.height * 300.0)  #Comprimento x Largura x Altura x Fator cubagem (300)
  pwr_gntr.save
end